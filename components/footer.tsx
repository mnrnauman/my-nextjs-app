...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#0a1128] text-white pt-20 pb-6" ref={ref}>
          ...
          <motion.div variants={itemVariants}>
            ...
            <div className="space-y-4">
              <div className="relative">
                ...
                />
                <Button
                  className="absolute right-1 top-1 bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 rounded-md p-2"
